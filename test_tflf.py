...
from model.tflocoformer import TFLocoformer_model
...
class Separation():
    def __init__(self, config_path):
        ...
        self.net = TFLocoformer_model(**self.opt['TFLocoformer'])
...
# python3 test_tflf.py --yaml config/tf-locoformer/test.yml
