...
train_mix_scp = 'tr_mix_xx.scp'
train_s1_scp = 'tr_s1_xx.scp'
train_s2_scp = 'tr_s2_xx.scp'

test_mix_scp = 'tt_mix_xx.scp'
test_s1_scp = 'tt_s1_xx.scp'
test_s2_scp = 'tt_s2_xx.scp'

cv_mix_scp = 'cv_mix_xx.scp'
cv_s1_scp = 'cv_s1_xx.scp'
cv_s2_scp = 'cv_s2_xx.scp'
